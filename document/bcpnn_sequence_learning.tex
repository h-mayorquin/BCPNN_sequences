...
\textbf{Number of patterns}: in figure \ref{fig:simple_bcpnn_learning} c) we depict the outcome of having a different number of patterns in the sequence on the connectivity matrix. 
